...
public class Comparisons {
    ...
    public void testLessOrEquals() {
        ...
        rational = new Rational(-2, 5);
        assertFalse("The comparison result is incorrect", rational.lessOrEqual(new Rational(-2, 7)));
        assertFalse("The comparison result is incorrect", rational.lessOrEqual(new Rational(-3, 5)));
    }
}
